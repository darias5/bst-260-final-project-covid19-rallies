...
# Step 3b: Merging map data into dataframe
...
# Step 6b: Lineplot of new cases for the median weighted on population density
...
p2 <- df %>%
  ...
  geom_vline(aes(xintercept = 0),
                 ...
                 linetype = "dashed") + 
  labs(title="Number of new confirmed COVID-19 cases per million people",
         subtitle = "Median weighted on population density",
    x = "Days until/after rally", 
       y = "Rolling 7-day average") +
  theme_bw()
...
# Step 6d: Lineplot of new deaths for the median weighted on population density
